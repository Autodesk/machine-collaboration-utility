 ...
 */
Job.prototype.processCommand = function processCommand(command) {
  let commandReply;
  switch (command) {
    case 'start':
      this.start();
...
Job.prototype.start = function start() {
  ...
  *
  */
Job.prototype.pause = function pause() {
 ...
 *
 */
Job.prototype.resume = function resume() {
  if (this.fsm.current === 'running') {
    return;
  }
  if (this.fsm.current !== 'paused') {
