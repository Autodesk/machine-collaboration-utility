...
class Bots extends _react2.default.Component {
  ...
  renderBotList() {
    ...
    const botRadioList = Object.entries(this.props.bots).map(_ref => {
  ...
  createPresetList() {
    const options = Object.entries(this.props.botPresets).map(_ref3 => {
  ...
  renderEndpoint(connectionType) {
    switch (connectionType) {
      ...
      default:
        _react2.default.createElement('input', { type: 'hidden', name: 'endpoint', value: undefined });
        break;
    }
  }
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (Object.entries(nextProps.bots).length <= 0) {
      ...
      if (nextProps.bots[this.state.selectedBot] === undefined) {
        newBotState = Object.entries(nextProps.bots).length > 0 ? Object.entries(nextProps.bots)[0][0] : undefined;
      }
    }
  ...
  render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        _Button2.default,
        { style: { margin: "10px" }, onClick: this.toggleModal },
        'Create Bot'
      ),
      this.renderBotList(),
      this.state.selectedBot === undefined ? '' : _react2.default.createElement(_Bot2.default, { currentJob: currentJob, conducting: this.props.conducting, botPresets: this.props.botPresets, bot: selectedBot }),
      _react2.default.createElement(
        _Modal2.default,
