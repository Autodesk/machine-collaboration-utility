...
class Files extends _react2.default.Component {
  ...
  getActiveBotUuid(props) {
    ...
    for (const _ref of _underscore2.default.pairs(this.props.bots)) {
  ...
  createBotList() {
    ...
    _underscore2.default.pairs(this.props.bots).map(_ref3 => {
  ...
  render() {
    const files = _underscore2.default.pairs(this.props.files).map(_ref5 => {
